    ...
    <>
      ...
      <main className="relative bg-warm-radial pt-32 pb-24 md:pt-40 md:pb-32 min-h-[70vh] flex items-center">
        <div className="container-tight text-center">
          ...
          <h1 className="mt-4 font-heading font-extrabold text-espresso text-3xl md:text-4xl tracking-tight">Looks like this page leaked through a crack in our foundation.</h1>
