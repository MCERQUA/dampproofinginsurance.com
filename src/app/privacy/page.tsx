          ...
          <FadeIn>
            ...
            <div className="prose-warm mt-8">
              ...
              <ul>
                ...
                <li>Information about your waterproofing operation needed to quote insurance (type of work, crew size, annual revenue, equipment value, chemical products used, loss history)</li>
